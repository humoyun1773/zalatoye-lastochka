        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {stepsData.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="luxury-card p-6 sm:p-7 rounded-3xl relative group flex flex-col justify-between border border-white/15 hover:border-blue-400 shadow-xl transition-all duration-300 overflow-hidden"
              >
                <div>
                ...
                <p className="text-xs text-slate-300 leading-relaxed border-t border-white/10 pt-4 mt-4">
                  {step.desc}
                </p>
              </div>
            );

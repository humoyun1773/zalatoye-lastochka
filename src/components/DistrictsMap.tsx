...
export const DistrictsMap: React.FC<DistrictsMapProps> = ({ lang, t }) => {
  ...
  return (
    <section id="districts" className="py-20 md:py-28 relative bg-slate-50/70 border-y border-slate-200/60">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4">
          {filteredDistricts.map((d) => (
            <div
              key={d.id}
              className="luxury-card p-4 sm:p-5 rounded-2xl border border-slate-200 hover:border-amber-400/80 transition-all duration-300 group flex flex-col justify-between"
            >
              <div>
                ...
                <h4 className="text-base font-bold text-slate-900 mb-3 group-hover:text-amber-700 transition-colors">
                  {getDistrictName(d)}
                </h4>
              </div>

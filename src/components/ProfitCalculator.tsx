...
import { Calculator, Sparkles, DollarSign, Calendar, Shield, CheckCircle, CreditCard, TrendingUp, AlertTriangle, Phone, Send, MapPin, FileText, ArrowUpRight } from 'lucide-react';
...
const PACKAGES_CONFIG: PackageConfig[] = [
  {
    ...
    badge: '1-Paket',
    badgeColor: 'bg-pink-600/30 text-pink-300 border-pink-400/50',
    pricePerUnit: 560000,
    profitPercent: 140,
    durationMonths: 17,
    durationLabel: '17 oy',
    monthlyDesc: '1-oy 168k (30%), 2-oy 112k (20%), 3–17 oylar 70.9k/oy',
  },
  {
    id: 2,
    name: '2-Paket: Optimal Daromad',
    badge: '2-Paket',
    badgeColor: 'bg-emerald-600/30 text-emerald-300 border-emerald-400/50',
    pricePerUnit: 940000,
    profitPercent: 100,
    durationMonths: 14,
    durationLabel: '14 oy',
    monthlyDesc: '1-oy 235k (25%), 2-oy 141k (15%), 3–14 oylar 125.3k/oy',
  },
  {
    id: 3,
  ...
  return (
    <section id="calculator" className="py-16 md:py-24 relative bg-transparent overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ─── OFFICIAL GUARANTEE NOTICE & CONTACT DETAILS (BELOW CALCULATOR) ─── */}
        <div className="space-y-4 mt-8 sm:mt-10 w-full">
          {/* Warning Banner */}
          <div className="p-4 sm:p-5 rounded-2xl bg-amber-500/15 border border-amber-400/30 flex items-center gap-3.5 text-slate-200 shadow-xl">
          ...
          {/* Contact Bar & Action Cards Grid */}
          <div className="luxury-card p-5 sm:p-6 rounded-3xl border border-white/20 shadow-2xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 items-stretch">
              ...
              <a
                ...
                className="flex items-center gap-3 p-3.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all hover:border-sky-400/50 group h-full"
              >
                ...
                <div className="min-w-0">
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Telegram:</span>
                  <span className="text-xs sm:text-sm font-black text-white font-mono whitespace-nowrap block">
                    @afrod991
                  </span>
                </div>
              ...
              {/* Location Card */}
              <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-white/5 border border-white/10 h-full">
                <div className="w-10 h-10 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0">
                  <MapPin className="w-5 h-5" />
                </div>
                <div className="min-w-0">
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Manzil:</span>
                  <span className="text-[11px] sm:text-xs font-bold text-white leading-tight block truncate" title="Qarshi sh., Eshon Shahid MFY, NUR o‘quv markazi">
                    Qarshi sh., NUR markazi
                  </span>
                </div>
              </div>
              ...
              {onOpenContract && (
                <button
                  ...
                  className="w-full blue-btn p-3.5 rounded-2xl text-xs sm:text-sm font-black flex items-center justify-center gap-2 shadow-xl cursor-pointer text-white hover:scale-[1.02] active:scale-[0.98] transition-all h-full whitespace-nowrap"
                >
                  <FileText className="w-4 h-4 text-white shrink-0" />
                  <span>Shartnoma namunasi</span>
